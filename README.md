...
| `examples/club_set.py` | Club-style demo with 11 dedicated sounds: sub_bass / hat_engine / neon_stab / acid_lead / warehouse_air / kick_pulse / floor_kick / glitch_ticks / soft_pluck / dub_chord / shimmer_pad |
